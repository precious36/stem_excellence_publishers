  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" className="h-10 w-10">
      <path
        ...
        fill="#0a62b2"
      />
      <path d="M28.8 28 23 22.8l-2.8 2.8 5 5.7h3.6Z" fill="#159956" />
    </svg>
  );
}
...
function CalculatorIcon() {
  return (
    <svg viewBox="0 0 36 36" aria-hidden="true" className="h-10 w-10">
      <rect x="4" y="2" width="28" height="32" rx="4" fill="#0ba8cf" />
      <rect x="8" y="6" width="20" height="6" rx="2" fill="#d7f7ff" />
      {[
        [8, 15],
        [15, 15],
        [22, 15],
        ...
        <rect key={`${x}-${y}`} x={x} y={y} width="5" height="5" rx="1" fill="#e6fcff" />
      ))}
    </svg>
  );
}
...
function RocketIcon() {
  return (
    <svg viewBox="0 0 36 36" aria-hidden="true" className="h-10 w-10">
      <path d="M21.9 3.4c3.7 1 7.4 4.7 8.4 8.4l-4.6 4.6-8.4-8.4 4.6-4.6Z" fill="#11a36c" />
      <path
        d="M17.3 8c-3.2 1.1-6.2 3.1-8.4 5.3l-2.5 2.5 4.2 1.2 4.3 4.3 1.2 4.2 2.5-2.5c2.2-2.2 4.2-5.2 5.3-8.4L17.3 8Z"
        fill="#2cc991"
      />
      <circle cx="18.8" cy="14.6" r="2.1" fill="#dcfff1" />
      <path d="M11.3 23.6 6 29v2h2l5.4-5.3-2.1-2.1Z" fill="#f3b736" />
    </svg>
  );
}
